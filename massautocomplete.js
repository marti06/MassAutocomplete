    ...
    .directive('massAutocomplete', ["$timeout", "$window", "$document", "$q", function ($timeout, $window, $document, $q) {
        ...
        return {
            ...
            controller: ["$scope", function ($scope) {
                ...
                function update_model_value(label) {
                    if (current_model.$modelValue !== label) {
                        current_model.$setViewValue(label);
                ...
                function set_selection(i) {
                    ...
                    current_element.val(selected.label);
                ...
                $scope.apply_selection = function (i) {
                    ...
                    last_selected_value = selected.label;
                    update_model_value(selected.label);
                    $scope.show_autocomplete = false;
